...
exports.commentQueryObj = void 0;
const initCommentsTable = "CREATE TABLE IF NOT EXISTS comments(id INT AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, service_id INT NOT NULL, comment VARCHAR(2000) NOT NULL, inReplyTo INT, hasReplies BOOL DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(id), FOREIGN KEY (service_id) REFERENCES services(id))";
const initVotesTable = "CREATE TABLE IF NOT EXISTS commentVotes(comment_id INT NOT NULL, user_id INT NOT NULL, vote_value INT NOT NULL, PRIMARY KEY (comment_id, user_id), FOREIGN KEY (comment_id) REFERENCES comments(id) ON DELETE CASCADE, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE)";
...
LIMIT ?
OFFSET ?`;
const voteComment = "INSERT INTO commentVotes (comment_id, user_id, vote_value) VALUES (?,?,?) ON DUPLICATE KEY UPDATE vote_value = ?";
exports.commentQueryObj = {
    initCommentsTable,
    initVotesTable,
    getParentComments,
    voteComment,
